                    ...
                    foreach ($json as $l => $item) {
                        ...
                        foreach ($item2 as $l2 => $item4) {
                            ...
                            if ($a == 1) {
                                ...
                                $displays = '<u type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdrops' . $l . '"><h5>' . $toopics . '</h5>
                                         </u>';
                                echo $displays;
                            ...
                            if ($a == 5) {
                                ...
                                $displays .= '<div class="modal fade" id="staticBackdrops' . $l . '" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <b>หมวดหมู่ :</b><br>' . $catts . '<br><b>หมวดหมู่ย่อย :</b><br>' . $subcatts . '<hr>' . $desscs . '<hr><a href="http://10.183.252.68/sing9/web/DownloadFile.php?File='.$File.'&name='.$name.'  " ><button class="btn" download ><i class="fa fa-download"></i>dOwNloAd</button></a>
                                                            </div>
                    ...
                    if ($k != 5000) {
                        ...
                        foreach ($item2 as $k2 => $item4) {
                            ...
                            if ($j == 1) {
                                ...
                                $display .= '<u type="button"  data-bs-toggle="modal" data-bs-target="#staticBackdrop' . $k . '"><h5>' . $toopic . '</h5>
                                 </u>';
                                //echo $display;
                                // $display = '';
                            ...
                            if ($j == 5) {
                                ...
                                $display .= '<div class="modal fade" id="staticBackdrop' . $k . '" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <b>หมวดหมู่ :</b><br>' . $catt . '<br><b>หมวดหมู่ย่อย :</b><br>' . $subcatt . '<hr>' . $dessc . '<hr><a href="http://10.183.252.68/sing9/web/DownloadFile.php?File='.$File.'&name='.$name.'  " ><button class="btn" download ><i class="fa fa-download"></i>dOwNloAd</button></a><hr>
                                                            </div>
                                                            <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
