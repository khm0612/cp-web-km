...
//     $zip->addFile('test.pdf');
    ...
    //$zip->addFile( $try, 'excel.xlsx');
 
    // Add a file new.txt file to zip using the text specified
    $zip->addFromString(basename($_REQUEST['pathFile']), file_get_contents($_REQUEST['pathFile']));
...
//     $file = json_decode($file);
    echo $file;
        // $sentStr = readfile($path);
        // $sentStr = base64_encode($sentStr);
        // echo $sentStr;
